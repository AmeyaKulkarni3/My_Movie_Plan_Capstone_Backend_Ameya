...
@Service
@PropertySource("classpath:firebaseDetails.properties")
public class FirebaseStorageService implements StorageStrategy{
	
	private final Logger log = LoggerFactory.getLogger(FirebaseStorageService.class);
	...
	@Override
	public ResponseEntity<Object> dowloadFile(String filename, HttpServletRequest request) throws IOException {
